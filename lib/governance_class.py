...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to mund "gobject list" output
    ...
    def mund_serialise(self):
        import munlib
        return munlib.SHIM_serialise_for_mund(self.serialise())
